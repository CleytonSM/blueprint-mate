...
public class DescriptionUpdateDTO {
    ...
    public DescriptionUpdateDTO() {
    }

    public DescriptionUpdateDTO(String bestPlace, String weekendBestPlace, String missActualHouse,
                                ...
                                String watchTv, Boolean hasRead, Boolean hasBookRead, Boolean hasTabletRead,
                                Boolean hasPets, String pets, Boolean hasCook, String cook) {
