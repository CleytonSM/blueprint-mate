...
public class NecessaryAppliancesInKitchenCreateDTO {
    ...
    public NecessaryAppliancesInKitchenCreateDTO() {
    }

    public NecessaryAppliancesInKitchenCreateDTO(String name, Boolean hasUsedDaily) {
        this.name = name;
